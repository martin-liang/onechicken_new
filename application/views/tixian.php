...
<head>
    ...
    <title>提现管理</title>
    <!-- Bootstrap core CSS -->
    <link rel="stylesheet" type="text/css" href="http://www.sqweichao.com/public/public/Css/admin/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="http://www.sqweichao.com/public/public/Css/jquery-ui.min.css" />
    <!-- Custom styles for this template -->
    <link rel="stylesheet" type="text/css" href="http://www.sqweichao.com/public/public/Css/admin/admin.css" />
    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="http://www.sqweichao.com/public/public/Js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script src="http://www.sqweichao.com/public/public/Js/ie-emulation-modes-warning.js"></script>
    <script type="text/javascript" src="http://www.sqweichao.com/public/public/Js/jquery.min.js"></script>
    <script type="text/javascript" src="http://www.sqweichao.com/public/public/Js/jquery.validate.js"></script>
    <script type="text/javascript" src="http://www.sqweichao.com/public/public/Js/jquery-impromptu.min.js"></script>

    <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
    <script src="http://www.sqweichao.com/public/public/Js/html5shiv.js"></script>
    <script src="http://www.sqweichao.com/public/public/Js/respond.min.js"></script>
    <![endif]-->
    <style>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="http://www.sqweichao.com/index.php/admin/show">用户信息</a></li>
                        <li><a href="http://www.sqweichao.com/index.php/admin/tixian">提现管理</a></li>
                    </ul>
                </li>
            ...
            <ul class="nav navbar-nav" style="float:right;">
                <li class="">
                    ...
                    <ul class="dropdown-menu" role="menu" style="right:0; left:auto;">
                        ...
                        <li><a href="http://www.sqweichao.com/index.php/admin/logout">退出登录</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<!--    </form>-->
    ...
    <script src="http://www.sqweichao.com/public/public/Js/html5shiv.js"></script>
    <script type="text/javascript" src="http://www.sqweichao.com/public/public/Js/bootstrap.min.js"></script>
    <script type="text/javascript" src="http://www.sqweichao.com/public/public/Js/jquery-ui.min.js"></script>
    <script type="text/javascript" src="http://www.sqweichao.com/public/public/Js/admin.js"></script>
    <script type="text/javascript" src="http://www.sqweichao.com/public/public/Js/jquery-ui-timepicker-addon.js"></script>
    <script type="text/javascript" src="http://www.sqweichao.com/public/public/Js/jquery.ui.datepicker-zh-CN.js.js" charset="gb2312" ></script>
    <script type="text/javascript" src="http://www.sqweichao.com/public/public/Js/jquery-ui-timepicker-zh-CN.js"></script>
</body>
</html>